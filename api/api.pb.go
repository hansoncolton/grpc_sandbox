...
func init() {
	...
	proto.RegisterType((*NoParam)(nil), "api.NoParam")
}
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
...
type PingClient interface {
	...
	SayHello(ctx context.Context, in *NoParam, opts ...grpc.CallOption) (*PingMessage, error)
}
...
func (c *pingClient) SayHello(ctx context.Context, in *NoParam, opts ...grpc.CallOption) (*PingMessage, error) {
	out := new(PingMessage)
...
type PingServer interface {
	//  rpc SayHello(PingMessage) returns (PingMessage) {
	SayHello(context.Context, *NoParam) (*PingMessage, error)
}
...
func (*UnimplementedPingServer) SayHello(ctx context.Context, req *NoParam) (*PingMessage, error) {
...
func _Ping_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingServer).SayHello(ctx, req.(*NoParam))
	}
